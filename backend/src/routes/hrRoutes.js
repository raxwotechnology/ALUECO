...
import {
    ...
    markAttendance, getAttendance, bulkMarkAttendance, importAttendanceFromExcel, importMonthlyAttendanceFromExcel,
...
router.post('/attendance/import-monthly', requirePermission('hr.attendance.manage'), uploadMemory.single('file'), importMonthlyAttendanceFromExcel);
