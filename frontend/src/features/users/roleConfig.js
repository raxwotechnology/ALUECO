export const ROLES = [
    ...
    {
        value: 'qs_production',
        label: 'Role 01: QS & Production Coordinator',
        description: 'Estimation, quotations, BOM, work orders and production tracking',
        color: '#8b5cf6',
        permissions: [
            'dashboard.view',
            'products.view',
    ...
    {
        value: 'hrm_accounts_procurement',
        label: 'Role 02: HRM, Accounts, Stock & Procurement',
        description: 'HR records, accounts entries, stock control, purchase orders and suppliers',
        color: '#059669',
        permissions: [
            'dashboard.view',
            'products.view',
    ...
    {
        value: 'sales_crm',
        label: 'Role 03: Sales, CRM & Marketing Assistant',
        description: 'Inquiries, follow-up, sales pipeline, quotation coordination and social media marketing',
        color: '#2563eb',
        permissions: [
            'dashboard.view',
            'products.view',
