...
export default function EmployeeFormPage() {
    ...
    const [form, setForm] = useState({
        employeeCode: '', firstName: '', lastName: '', gender: '', dateOfBirth: '', nationalIdNumber: '',
    ...
    const submit = async () => {
        ...
        // Validate employeeCode format if manually entered
                    ...
                    {tab === 'basic' && (
                        <>
                            <div className="grid grid-cols-2 gap-4">
                                <Input label="Employee Code" required value={form.employeeCode} onChange={(e) => update('employeeCode', e.target.value)} placeholder="Leave empty to auto-generate" />
                                <div></div>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
