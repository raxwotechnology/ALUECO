                ...
                <div className="col-span-2 space-y-6">
                    <Card className="p-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">AluEco Profile Code</label>
                                    <select
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">AluEco Glass Code</label>
                                    <select
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">AluEco Accessory Code</label>
                                    <select
                                        ...
                                        className="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-indigo-500"
                                    >
                                        <option value="">Select Accessory Code</option>
